      ...
      <div className="flex flex-col justify-center bg-gradient-to-t from-orange-power to-blue-power z-0 pt-1">
        <div className="flex justify-center bg-dark-apple px-8 pt-16 pb-12 text-center">
          <a
            ...
            href="https://www.linkedin.com/in/vlad-anitas-388a21223/"
          >
            <svg
          ...
          <a
            className="flex content-center mx-4 justify-center text-center p-2 border-2 border-light rounded-xl w-10"
            href="https://github.com/Anitas-Vlad"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5 text-light"
