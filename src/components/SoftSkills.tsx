...
function SoftSkills() {
  ...
  return (
    <div className={classNames("flex flex-col mt-6 duration-300")}>
      <p className="flex relative self-center bg-blue-power backdrop-blur-3xl w-fit rounded-xl justify-center items-center top-7 z-10 text-light font-bold text-xl py-3 px-4">
        Soft Skills
      </p>
