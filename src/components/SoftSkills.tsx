...
function SoftSkills(){
    return (
        <div className="flex flex-col mt-6">
            <div className="flex relative bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-cyan-500/30 to-blue-700/20 backdrop-blur-3xl border-2 border-light shadow-lg w-32 h-32 rounded-full justify-center items-center top-16 self-center z-10">
